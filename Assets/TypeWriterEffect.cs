...
public class typewriterUI_v2 : MonoBehaviour
{
	...
	{
		if (characterDlog.activeInHierarchy)
		{
			startOnEnable = true;
			OnEnable();
		}
		print("On Enable!");
		if (startOnEnable == true)
		{
			StartTypewriter();
		}
...
//    [SerializeField] float timeBTWCharacters;
...
//        int totalVisableCharacters = _textMeshPro.textInfo.characterCount;
//        int counter = 0;
...
//{
//	print("On Enable!");
//	if (characterDlog.activeInHierarchy == true)
//	{
//		StartTypewriter();
//	}
//}
